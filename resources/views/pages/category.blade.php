...
<div class="flex flex-col items-center h">
    ...
    <div class="rounded-lg mt-5 flex text-center justify-center items-center relative">
    ...
    <div class="rounded-lg mt-5 flex text-center justify-center items-center relative">
        ...
        <a href="#" class="bg-white py-3 px-8 hover:bg-black hover:text-white rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            HISTORICAL PLACES
        </a>
    </div>
    <div class="rounded-lg mt-5 flex text-center justify-center items-center relative">
