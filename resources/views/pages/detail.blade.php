...
<div class="pt-16">
    <div class="relative">
        ...
        <div class="absolute text-white text-center right-0 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <h1 class="font-black text-5xl"><span class="uppercase">{{ $data->category }}</span> IN BATAM ISLAND</h1>
            <p>Find which destination you like to go by look out the <span class="lowercase">{{ $data->category }}</span> below</p>
        </div>
    </div>
