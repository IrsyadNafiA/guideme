...
<div class="flex gap-16 justify-center my-7">
    ...
    <a href="/add_arrival" class="flex hover:bg-slate-50 items-center justify-center w-52 h-52 rounded-2xl shadow-md bg-white border relative">
        <h1 class="my-3 mx-4 text-end lg:text-4xl text-sm font-black absolute top-0 right-0">6</h1>
        <p>Arrival Location</p>
    </a>
    <a href="/add_places" class="flex hover:bg-slate-50 items-center justify-center w-52 h-52 rounded-2xl shadow-md bg-white border relative">
