...
<aside id="logo-sidebar" class="w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-white shadow-lg">
        <a href="https://flowbite.com/" class="flex items-center pl-2.5">
            ...
            <span>
                <h1 class="text-center my-7 lg:text-lg text-sm font-black ml-3 ">Veve</h1>
            </span>
        </a>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/add_places" class="{{ Request::is('add_places') ? 'active: bg-gray-100 text' : '' }} flex items-center p-2 text-gray-900 fill-gray-500 hover:fill-black rounded-lg hover:bg-gray-100 group">
