...
<div class='flex items-center justify-center'>
  <div class='flex flex-col items-center justify-center text-center max-w-6xl gap-5'>
    <div>
      ...
      <p class="px-4 lg:px-0">The Guide Me application is an application created through collaboration between Batam City Tourism Office with BKS Team. Through this application we hope to help foreign tourists as well as local tourists who want to take a vacation to Batam City to easily find destinations in all of Batam City.</p>
    </div>
